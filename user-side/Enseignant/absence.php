...
<form class='form-example' method='post' action='eleveA.php'>
<table style="border-spacing:1px">
    <tr>
    <?php require_once('../../controllers/EnseignementController.php');
    ...
    foreach($res as $ligne){  
        ...
        echo "<option value='{$x['codeM']}'>{$x['codeM']} -- ".$x['nomM']."</option>";
              ...
              <input type="submit" name="Submit" value="Passer Au Choix D'Élève" style='font-size:1.5rem;margin:1rem'/>
