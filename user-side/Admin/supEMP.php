...
<form class='form-example' method='post' action='supEMP_act.php'>
<table style="border-spacing:1px">
    ...
    <div class="verif"><?php if(isset($_GET['p'])){ echo "<span style='color:red;font-size:1.5rem'>Horaire De Travail supprimé avec succés ! </span>";}?></div>
    </table> <div class="form-example">
              <input type="submit" name="Submit" value="Supprimer" style='font-size:1.5rem;margin:1rem'/>
